...
/* ========== Default Card ========== */
function DefaultCard({ article, index }: { article: NewsArticle; index: number }) {
  return (
    <article
      className="group relative cursor-pointer transition-all duration-500 hover:-translate-y-1.5"
      style={{
    ...
    >
      ...
      <div className="relative overflow-hidden" style={{ borderRadius: "1rem" }}>
        {/* Image */}
        <div className="relative h-44 overflow-hidden" style={{ borderRadius: "1rem 1rem 0 0" }}>
          <img
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(8, 20, 35, 0.8) 0%, transparent 50%)",
            }}
          />
          <div className="absolute top-3 left-3">
            <span
              className="px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-white"
              style={{
        ...
        {/* Content */}
        <div className="p-4">
          <h3 className="text-sm font-bold text-white leading-snug mb-2 line-clamp-2 group-hover:text-[#4dd0e1] transition-colors duration-300">
            {article.title}
          </h3>
